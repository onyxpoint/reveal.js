...
This project is a customization of "Reveal.js":http://lab.hakim.se/reveal-js for my own purposes. The original Github repository is "here":https://github.com/hakimel/reveal.js, go there for the original README file with an explanation of how to use it.
